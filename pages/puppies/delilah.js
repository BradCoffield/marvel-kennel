...
export default function Delilah() {
  return (
    <>
      ...
      <FlexedImages>
        <Card>
          <img src="\assets\delilah\Delilah.jpg" alt="" />
        </Card>
        <Card>
          <img src="\assets\delilah\Delilah2.jpg" alt="" />
        </Card>
        <Card>
          <img src="\assets\delilah\Delilah3.jpg" alt="" />
        </Card>
        <Card>
          <img src="\assets\delilah\Delilah4.jpg" alt="" />
        </Card>
      
      </FlexedImages>

      <ContactCalloutButton><Link href="/contact">Interested in adopting? Contact us!</Link></ContactCalloutButton>
    </>
  );
}
