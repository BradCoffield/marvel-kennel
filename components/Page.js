...
#content-wrap{min-height:100vh;}
  ...
  body {
    font-family:  'PT Sans', acuta,'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;
    padding: 0;
    margin: 0;
    font-size: 1.2rem;
    line-height: 2;
  ...
  *, *:before, *:after{
  ...
  p {
  font-family: 'PT Sans', acuta, serif;
  font-weight: 400;
  font-style: normal;
  color: #111;
}
